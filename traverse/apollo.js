const apolloUtilities = {};

apolloUtilities.hasApolloProvider = function hasApolloProvider(body) {
...
apolloUtilities.findApolloClientFile = function findApolloClientFile(body) {

}

module.exports = apolloUtilities;
